...
(function (Layers) {
    ...
    var PlayMethodLayer = (function (_super) {
        __extends(PlayMethodLayer, _super);
        function PlayMethodLayer() {
            var _this = _super.call(this) || this;
            // this._gameTypeId = _gameTypeId;
            _this.loadKey = ResManager.GROUP_NAME.CREATEROOM;
            _this.skinName = Layers.PlayMethodSkin;
            return _this;
        }
        PlayMethodLayer.prototype.init = function () {
            if (this._isInit) {
                return;
            }
            // this.destroyLoidImg();
            var list = [];
            for (var key in Config.gameConf.cardRoom) {
        ...
        PlayMethodLayer.prototype.childrenCreated = function () {
        ...
        PlayMethodLayer.prototype.chanTab = function (evt) {
            this._label.textFlow = helpDescs[this._tabBar.selectedItem.id];
            this._scroller.viewport.scrollV = 0;
        };
        return PlayMethodLayer;
    }(Layers.BaseLayer));
    Layers.PlayMethodLayer = PlayMethodLayer;
    __reflect(PlayMethodLayer.prototype, "Layers.PlayMethodLayer");
})(Layers || (Layers = {}));
//# sourceMappingURL=PlayMethodLayer.js.map