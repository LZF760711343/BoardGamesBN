...
(function (niuniu) {
    ...
    (function (brnn) {
        var Player = (function (_super) {
            ...
            Player.prototype.start = function (type) {
                // egret.log("type", type);
            ...
            */
            ...
            Player.prototype.updateInfo = function (playerDto) {
                _super.prototype.updateInfo.call(this, playerDto);
                this._nameLb.text = Utils.subString(playerDto.nickName, 5);
                if (playerDto.nickName.length > 6)
                    this._nameLb.text = this._nameLb.text + "...";
            };
            Player.prototype.updateChips = function (value, isDoAni) {
                _super.prototype.updateChips.call(this, value, isDoAni);
                this._chipsLb2.text = this._chipsLb.text;
            };
            return Player;
        }(PlayerBase));
        brnn.Player = Player;
        __reflect(Player.prototype, "niuniu.brnn.Player");
